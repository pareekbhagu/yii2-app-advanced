...
CREATE TABLE "archived_students" (
  "id" int(11) NOT NULL,
  "admission_no" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "class_roll_no" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  "address_line1" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "address_line2" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "city" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "state" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "pin_code" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  "photo_content_type" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  "former_id" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "created_at" datetime DEFAULT NULL,
  "updated_at" datetime DEFAULT NULL,
...
CREATE TABLE "attendance_student" (
  ...
  "date" date NOT NULL,
  "period" varchar(255) DEFAULT 'day',
...
CREATE TABLE "com_sms_settings" (
  "id" int(11) NOT NULL,
  "settings_key" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE "ed_courses" (
  "id" int(11) NOT NULL,
  "course_name" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE "events_old" (
  ...
  "origin_type" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY ("id"),
...
CREATE TABLE "exam_groups" (
  ...
  "name" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "batch_id" int(11) DEFAULT NULL,
  "exam_type" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE "fee_finance_donations" (
  "id" int(11) NOT NULL,
  "donor" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "description" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE "fee_finance_transactions" (
  ...
  "finance_type" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "payee_id" int(11) DEFAULT NULL,
  "payee_type" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "receipt_no" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE "hr_apply_leaves" (
  ...
  "manager_remark" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY ("id")
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE "hr_employee_leave_types" (
  ...
  "code" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "status" tinyint(1) DEFAULT NULL,
  "max_leave_count" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE "hr_employees" (
  ...
  "experience_detail" text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  ...
  "blood_group" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "nationality_id" int(11) DEFAULT NULL,
  "home_address_line1" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "home_address_line2" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "home_city" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "home_state" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "home_country_id" int(11) DEFAULT NULL,
  "home_pin_code" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "office_address_line1" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "office_address_line2" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "office_city" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "office_state" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "office_country_id" int(11) DEFAULT NULL,
  "office_pin_code" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "office_phone1" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "office_phone2" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "mobile_phone" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "home_phone" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "email" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE "info_guardians" (
  ...
  "first_name" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "last_name" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "relation" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "email" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "office_phone1" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "office_phone2" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "mobile_phone" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  "income" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE "info_students" (
  ...
  "immediate_contact_id" int(11) DEFAULT NULL,
  "is_sms_enabled" tinyint(1) DEFAULT '1',
  "photo_url" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "status_description" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "is_active" tinyint(1) DEFAULT '1',
  "is_deleted" tinyint(1) DEFAULT '0',
  "created_at" datetime DEFAULT NULL,
...
CREATE TABLE "lib_book" (
  ...
  "issued_to" varchar(120) DEFAULT NULL,
  PRIMARY KEY ("id"),
...
CREATE TABLE "tt_class_timings" (
  ...
  "batch_id" int(11) DEFAULT NULL,
  "name" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "start_time" varchar(120) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  "end_time" varchar(120) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE "tt_weekdays" (
  "id" int(11) NOT NULL,
  "batch_id" int(11) DEFAULT NULL,
  "weekday" varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY ("id"),
...
-- Dump completed on 2016-10-14 23:52:13
